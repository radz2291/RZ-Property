...
export default function MobileFilterDrawer({
  ...
  // Count active filters (excluding empty price fields)
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="max-h-[85vh] overflow-y-auto">
            ...
            <AccordionItem value="price">
              ...
              <AccordionContent>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="drawer-min-price">Minimum (RM)</Label>
                    <Input
                      id="drawer-min-price"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="drawer-max-price">Maximum (RM)</Label>
                    <Input
                      id="drawer-max-price"
                      type="number"
        ...
        <DrawerFooter className="sticky bottom-0 bg-background border-t pb-6">
          <div className="text-center text-muted-foreground mb-2">
            {totalProperties} properties match
          </div>
